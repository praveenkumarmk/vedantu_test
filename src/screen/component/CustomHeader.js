...
const CustomHeader = ({ onPress, onSearchPress,onOverViewPress,onRepositoriesPress,onStarPress}) => {
  return (
    <View style={styles.imageContainer}>
      ...
      <TouchableOpacity onPress={onOverViewPress}>
         <Text style={{color:color.white,fontSize:20}} >OverView</Text></TouchableOpacity>
         <TouchableOpacity onPress={onRepositoriesPress}>
         <Text style={{color:color.white,fontSize:20}} >Repositories</Text></TouchableOpacity>
         <TouchableOpacity onPress={onStarPress}>
         <Text style={{color:color.white,fontSize:20}} >Stars</Text></TouchableOpacity>
        </View>
    </View>
  );
};
